...
{
    public partial class Employees_element : UserControl
    {
        public Employees_element()
        {
            InitializeComponent();
        }
        ...
        {
            get { return _name_; }
            set { _name_ = value; FirstName.Text = value; }
        }

        private string _last_name_;
        public string LastName_
        {
            get { return _last_name_; }
            set { _last_name_ = value; LastName.Text = value; }
        }
        private string _id_;
        public string ID_
        {
       ...
       private string _mobileNember_;
        ...
        private string _salary_;
        public string Salary_
        {
            get { return _salary_; }
            set { _salary_ = value; salary.Text = value; }
        }
